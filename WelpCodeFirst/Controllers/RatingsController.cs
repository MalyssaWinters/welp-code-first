...
namespace WelpCodeFirst.Controllers
{
    public class RatingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RatingID,UserID,BusinessID,StarRating,TextReview")] Rating rating)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RatingID,UserID,BusinessID,StarRating,TextReview")] Rating rating)
        {
            if (ModelState.IsValid)
            {
