...
namespace WelpCodeFirst.Controllers
{
    public class BusinessTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BusinessTypeID,TypeName")] BusinessType businessType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BusinessTypeID,TypeName")] BusinessType businessType)
        {
            if (ModelState.IsValid)
            {
