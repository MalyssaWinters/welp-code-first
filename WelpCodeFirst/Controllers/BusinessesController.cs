...
namespace WelpCodeFirst.Controllers
{
    public class BusinessesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BusinessID,BusinessTypeID,BusinessName,Address,Hours,Phone,Menu,UserID")] Business business)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BusinessID,BusinessTypeID,BusinessName,Address,Hours,Phone,Menu,UserID")] Business business)
        {
            if (ModelState.IsValid)
            {
